...
class LocationFrequencyDB:
    ...
    def _init_database(self):
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_repeaters_location ON repeaters(latitude, longitude)')

        cursor.execute('CREATE INDEX IF NOT EXISTS idx_public_safety_freq ON public_safety(frequency)')
    ...
    def get_stats(self) -> dict:
        ...
        return {
            ...
            'marine': marine_count,
            'total': repeater_count + public_safety_count + noaa_count + aviation_count + marine_count
        }
