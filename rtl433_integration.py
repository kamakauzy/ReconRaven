        ...
        try:
            ...
            if devices:
                ...
                return {
                    ...
                    'devices': [],
                    'count': 0,
                    'message': 'No devices recognized'
                }
                
        except subprocess.TimeoutExpired:
            return {
                'success': False,
                'error': 'rtl_433 timed out (>60s)'
            }
    ...
    def print_device_info(self, devices):
        ...
        for i, device in enumerate(devices, 1):
            ...
            for key, value in device.items():
                if key not in ['model', 'id', 'channel', 'temperature_C', 'humidity', 
                              'pressure_hPa', 'rssi', 'snr', 'time']:
                    print(f"  {key}: {value}")
